            ...
            if (bytes != null)
            {
                ...
                if (!string.IsNullOrEmpty(s))
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        Vector3 position;
                        position.x = m.m03;
                        position.y = m.m23;//change y and z
                        position.z = m.m13;
                        ...
                        if (m.m22 < 0.0f)
                        {
                            if (m.m00 > m.m11)
                            {
                                t = 1.0f + m.m00 - m.m11 - m.m22;
                                x = t; y = m.m01 + m.m10; z = m.m20 + m.m02; w = m.m12 - m.m21;
                            }
                            else
                            {
                                t = 1.0f - m.m00 + m.m11 - m.m22;
                                x = m.m01 + m.m10; y = t; z = m.m12 + m.m21; w = m.m20 - m.m02;
                            }
                        }
                        else
                        {
                            ...
                            {
                                t = 1.0f - m.m00 - m.m11 + m.m22;
                                x = m.m20 + m.m02; y = m.m12 + m.m21; z = t; w = m.m01 - m.m10;
                            }
                            else
                            {
                                t = 1.0f + m.m00 + m.m11 + m.m22;
                                x = m.m12 - m.m21; y = m.m20 - m.m02; z = m.m01 - m.m10; w = t;
                            }
                        }
